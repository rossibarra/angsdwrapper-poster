...
ANGSD has already been used in several studies to analyze genome sequence data \cite{Crawford}. %add cites
...
Here we present a software package that aids in the preparation of analyses for ANGSD and provides interactive graphing software implemented in R \cite{R} and Shiny \cite{blah}.  %add cites
...
Both species share the AA genome \ref{Vaughan} and we have successfully crossed them experimentally, providing reason to believe the possibility of natural hybridization and thus the risk of wild population decline and extinction \cite{Rhymer}. 
