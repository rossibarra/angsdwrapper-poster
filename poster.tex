...
Preliminary analysis using ANGSD-wrapper is suggestive of introgression (Figure \ref{gluma}): nucleotide diversity in the sympatric population of \emph{Oryza glumaepatula} is more strongly correlated with domesticated rice (Spearman's $\rho=0.537$) than with the allopatric population ($\rho=XXX$).  Nucleotide diversity in the allopatric population, in contrast, shows little correlation with diversity in domesticated samples ($\rho=0.139$).
...
3\bibitem{Korneliussen} Korneliussen et al. (2014). BMC Bioinformatics. 15:356
2\bibitem{Fumagalli} Fumagalli, M., F. G. Vieira, T. Linderoth and R. Nielsen (2014). Bioinformatics 30(10): 1486-1487.
1\bibitem{Crawford} Crawford, J., M. M. Riehle, W. M. Guelbeogo, A. Gneme, N. f. Sagnon, K. D. Vernick, R. Nielsen and B. P. Lazzaro (2014).  bioRxiv.
4\bibitem{Lohmueller} Lohmueller, et al. (2013). American Journal of Human Genetics, 93(6), 1072–1086.
5\bibitem{R} R Core Team (2014). R Foundation for Statistical Computing, Vienna, Austria \url{http://www.R-project.org/}
7\bibitem{Shiny} Rstudio, Inc. (2013). \url{http://www.rstudio.com/shiny/}
9\bibitem{Zhang} Zhang, Q.-J., et al. (2014). PNAS 111(46): E4954-E4962.
8\bibitem{Vaughan} Vaughan DA, Morishima H, and Kadowaki K (2003). Current Opinion in Plant Biology 6:139-146.
6\bibitem{Rhymer} Rhymer JM and Simberloff D (1996). Annu Rev Ecol Syst 27:83-109.
